        ...
        <Container>
          <div className="relative z-20 p-6 md:p-[60px] xl:pt-[80px] xl:pr-[120px] xl:pb-[80px] xl:pl-[80px] rounded-[22px] md:rounded-[30px] border-solid border-1 bg-white/5 flex flex-col md:flex-row items-center gap-4 backdrop-blur-lg">
            <div className="md:w-1/2">
              <h1 className="text-[36px] md:text-[66px] font-gs mb-8 md:mb-17.5 font-light">
                <span className="font-serif">get in</span>{" "}
                <em className="font-serif">touch</em> with us
              </h1>
              <p className="md:max-w-[590px] text-[16px] md:text-[26px] mb-6 md:mb-10 font-medium">
                Transparent. Scalable. Designed for You.
              </p>
              <p className="md:max-w-[440px] text-[16px] md:text-[26px] font-medium">
                Get in touch to discuss pricing, to explore our platform through
                a free demo or just to talk to us.
              </p>
            </div>
            ...
            <div className="md:w-1/2">
              ...
              >
                <div className="flex flex-col md:flex-row gap-[24px] md:gap-[60px] mb-[24px] md:mb-[60px]">
                  <input
                    className="leading-none placeholder:text-white/80 py-5 border-b-1 uppercase text-[16px] md:text-[24px] w-full"
                    type="text"
                    name="first_name"
                ...
                <div className="flex flex-col md:flex-row mb-[18px] md:mb-[50px]">
                  <textarea
                    className="leading-none placeholder:text-white/80 py-2 border-b-1 uppercase text-[16px] md:text-[24px] w-full h-[134px]"
                    name="message"
                    placeholder="Message *"
                    required
                  ></textarea>
                ...
                <div className="flex flex-col md:flex-row mb-[18px] md:mb-[50px]">
                  <button
                    type="submit"
                    className="uppercase bg-white/20 border border-white text-white px-8 py-3 rounded-full cursor-pointer inline-flex items-center justify-center gap-2 relative group lg:hover:pr-14 pinpoynt-transition"
                  >
                    <span>Submit</span>
